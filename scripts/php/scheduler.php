...
foreach ($automations as $automationItem) {
    try {
        ...
        if ($format === 'excel') {
            ...
            // La ruta relativa falla en cron. Usamos la ruta absoluta que se define arriba.
            // RUTA ANTERIOR: $cssPath = realpath(__DIR__ . '/../../styles/reports/reportes.css');
            $cssPath = get_project_file_path('/styles/reports/reportes.css');
            $extraCss = '';
